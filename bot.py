...
GEMINI_API_KEY = "AQ.Ab8RN6IBDmdlAHhVzqZUWA4OCyVpfEv2LIhe4AL2uiSGHw20sQ"
...
# GenAI Client ကို တည်ဆောက်ခြင်း
...
def ai_translate(text, target_instruction):
    ...
    try:
        ...
        logging.error(f"Gemini API Error details: {e}")
    return "ဘာသာပြန်ဆိုရာတွင် ချို့ယွင်းချက်ရှိပါသည်"
